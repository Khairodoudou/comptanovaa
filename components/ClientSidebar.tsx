  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-white/10">
        <div className="w-9 h-9 rounded-xl bg-[#2d8f5e] flex items-center justify-center shadow-lg shrink-0">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all group ${
                active
                  ? "bg-[#2d8f5e] text-white shadow-sm"
      ...
      <div className="border-t border-white/10 p-3 space-y-2">
        ...
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/5">
          <div className="w-8 h-8 rounded-full bg-[#2d8f5e] flex items-center justify-center text-white text-xs font-bold shrink-0">
