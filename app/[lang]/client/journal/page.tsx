    ...
    <div className="p-8 max-w-6xl mx-auto space-y-6">
      ...
      <div className="space-y-6">
        ...
        {Object.values(
          ...
          return (
            <div key={doc?.id || Math.random()} className="bg-white rounded-2xl border border-slate-200/60 shadow-[0_2px_10px_-3px_rgba(45,143,94,0.05)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 p-6 flex flex-col gap-6">
              
              {/* Premium Document Header */}
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                <div className="flex gap-4 items-start">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center shrink-0 border border-green-100/50 shadow-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#2d8f5e]"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>
                  </div>
                  <div>
                      ...
                      return (
                        <>
                          ...
                          {debitRows.map((row, idx) => (
                            <tr key={`d-${idx}`}>
                              <td className="py-1 px-4 text-center font-mono text-[#2d8f5e] border-x border-black align-top">{row.account}</td>
                              ...
                              <td className="py-1 px-4 text-left text-[#2d8f5e] border-x border-black align-top">{formatAmount(row.amount)}</td>
